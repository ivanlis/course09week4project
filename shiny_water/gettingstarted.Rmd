...
Use the *'Toggle Documentation'* button to make this documentation appear/disappear.

#### Output

The main panel displays up to three pieces of output:

- *This documentation* if you make it appear with the *'Toggle Documentation'* button.
